...
for config in $configurations; do
    ...
    xcodebuild -configuration $config -workspace $src/MoaiSample.xcodeproj/project.xcworkspace -scheme moai-fmod -sdk macosx10.7 build CONFIGURATION_BUILD_DIR=/tmp/osx/$job/MoaiSample/moai-fmod/macosx/$config
